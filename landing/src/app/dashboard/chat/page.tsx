    ...
    <div className="flex flex-col h-[calc(100vh-120px)]">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            href={`/dashboard/compare${input ? `?prompt=${encodeURIComponent(input)}` : ''}`}
            className="px-4 py-2 rounded-lg text-white font-medium transition-all flex items-center gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500"
