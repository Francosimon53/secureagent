 ...
 *
 * Abstract base class for all productivity providers and a registry
...
export class ProviderRegistry {
   ...
   */
  get<T extends BaseProvider>(type: string, name?: string): T | undefined {
   ...
   */
  getDefault<T extends BaseProvider>(type: string): T | undefined {
